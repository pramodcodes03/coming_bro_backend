...
class GodsEyeController extends Controller
{
    ...
    private function snapshot(): array
    {
        ...
        $driverPayload = $drivers->map(function (DriverUser $d) use ($now, $activeByDriver) {
            ...
            return [
                ...
                'ip' => $d->last_login_ip ?: $d->register_ip,
    ...
    private function tripPayload(Order $o): array
    {
        ...
        return [
            ...
            'is_return_ride' => $o->return_ride_id !== null,
            ...
            'start_label' => $o->created_date?->format('d M Y, h:i A'),
            'end_label' => $o->update_date?->format('d M Y, h:i A'),
            'passenger' => [
                'name' => $o->customer?->full_name,
                'phone' => $o->customer?->phone_number,
                'ip' => $o->customer?->last_login_ip ?: $o->customer?->register_ip,
            ...
            'driver' => $o->driver ? [
                ...
                'ip' => $o->driver->last_login_ip ?: $o->driver->register_ip,
