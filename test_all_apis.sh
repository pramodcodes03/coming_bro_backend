...
test_api POST "$BASE/wallet/update" '{"amount":"100","transaction_id":"test_txn_001","payment_type":"credit","note":"Test deposit"}' "yes" "Wallet Update"
...
test_api POST "$BASE/bank-details" '{"bank_name":"SBI","holder_name":"Test Driver","branch_name":"Mumbai","account_number":"1234567890","other_information":"IFSC: SBIN0001234"}' "yes" "Create/Update Bank Details"
...
test_api GET "$BASE/reviews/1" "" "yes" "Get Review By Order"

echo ""
echo "--- Chat ---"
test_api GET "$BASE/chat/inbox" "" "yes" "Chat Inbox"
test_api POST "$BASE/chat/message" '{"order_id":1,"receiver_id":1,"message":"Hello test","message_type":"text"}' "yes" "Send Chat Message"
test_api GET "$BASE/chat/1/messages" "" "yes" "Get Chat Messages"

echo ""
echo "--- Subscriptions ---"
test_api GET "$BASE/subscriptions" "" "yes" "List Subscription Plans"
test_api GET "$BASE/subscriptions/history" "" "yes" "Subscription History"
