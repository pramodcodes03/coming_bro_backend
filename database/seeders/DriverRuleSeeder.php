...
class DriverRuleSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($records as $record) {
            DB::table('driver_rules')->updateOrInsert(['id' => $record['id']], $record);
        }
    }
}
