...
class OnBoardingSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($legacyRecords as $record) {
            DB::table('on_boardings')->updateOrInsert(['title' => $record['title'], 'type' => $record['type']], $record);
        }
        ...
        foreach ($screens as $screen) {
            DB::table('onboarding_screens')->updateOrInsert(['title' => $screen['title'], 'type' => $screen['type']], $screen);
        }
    }
}
