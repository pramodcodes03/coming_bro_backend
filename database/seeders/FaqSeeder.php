...
class FaqSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($records as $record) {
            DB::table('faqs')->updateOrInsert(['id' => $record['id']], $record);
        }
    }
}
