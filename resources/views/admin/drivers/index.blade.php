                        ...
                        @forelse($drivers as $driver)
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="flex flex-wrap justify-center gap-2 w-[200px] mx-auto">
                                        <a href="{{ route('admin.drivers.view', $driver->id) }}"
                                           class="inline-flex items-center justify-center gap-1 w-[94px] px-2 py-1.5 text-xs font-medium text-emerald-600 bg-emerald-50 rounded-md hover:bg-emerald-100 transition dark:bg-emerald-900/20 dark:hover:bg-emerald-900/30 whitespace-nowrap">
                                            <svg class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                            View
                                        </a>
                                        <a href="{{ route('admin.drivers.edit', $driver->id) }}"
                                           class="inline-flex items-center justify-center gap-1 w-[94px] px-2 py-1.5 text-xs font-medium text-[#018DBD] bg-[#018DBD]/10 rounded-md hover:bg-[#018DBD]/20 transition whitespace-nowrap">
                                        ...
                                        <button type="button"
                                           ...
                                           class="inline-flex items-center justify-center gap-1 w-[94px] px-2 py-1.5 text-xs font-medium text-white rounded-md bg-gradient-to-r from-[#018DBD] to-[#13C3C3] hover:opacity-90 transition whitespace-nowrap">
                                        ...
                                        <button type="button"
                                           ...
                                           class="inline-flex items-center justify-center gap-1 w-[94px] px-2 py-1.5 text-xs font-medium text-white rounded-md bg-gradient-to-r from-emerald-500 to-green-500 hover:opacity-90 transition whitespace-nowrap">
