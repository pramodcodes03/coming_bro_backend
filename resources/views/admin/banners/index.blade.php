...
<div class="space-y-5">
    <div class="flex flex-wrap items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            <form method="GET" action="{{ route('admin.banners.index') }}" class="relative">
        ...
        <div class="overflow-x-auto">
            <table class="table-hover">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="POST" action="{{ route('admin.banners.toggle-status', $banner) }}" class="inline">
                                    @csrf @method('PATCH')
                                    <button type="submit" class="badge {{ $banner->enable ? 'bg-success' : 'bg-danger' }}">
                                        {{ $banner->enable ? 'Active' : 'Inactive' }}
                                    </button>
                                </form>
                            </td>
                            <td class="text-center">
                                <div class="flex items-center justify-center gap-3">
                                    <a href="{{ route('admin.banners.edit', $banner) }}" class="hover:text-primary">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center py-4 text-gray-500">No banners found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
