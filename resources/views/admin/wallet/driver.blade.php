...
<div class="space-y-5">
    <div class="flex flex-wrap items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            <form method="GET" action="{{ route('admin.wallet.driver') }}" class="relative">
                ...
                <tbody>
                    @forelse($transactions as $transaction)
                        <tr>
                            ...
                            <td class="font-semibold whitespace-nowrap">{{ $transaction->user->full_name ?? $transaction->driver->full_name ?? 'N/A' }}</td>
                            <td>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center py-4 text-gray-500">No driver wallet transactions found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
