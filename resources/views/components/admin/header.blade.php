            ...
            <div
                ...
                <div class="flex-shrink-0 dropdown" x-data="dropdown" @click.outside="open = false">
                    <a href="javascript:;" class="relative group" @click="toggle()">
                        <span
                            class="flex items-center justify-center object-cover w-10 h-10 text-base font-bold text-white text-center rounded-full bg-primary">
                    ...
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                        ...
                        <li class="border-t border-white-light dark:border-white-light/10">
                            <a href="{{ route('admin.logout') }}" class="text-danger !py-3" @click="toggle">
